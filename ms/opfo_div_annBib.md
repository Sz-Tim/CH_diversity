...
- **Useful as an example of CitSci use in conservation**
- Individual SDMs
...
- **USE FOR MULTINOM JUSTIFICATION**
...
- **USE FOR GENERAL CONTRIBUTION OF CIT SCI**
...
- **USE FOR BACKGROUND ON CITIZEN SCIENCE**
...
- **USE FOR SHORTFALL IN INSECT DATA**
- Bias in GBIF
...
- **USE FOR TAXONOMIC BIAS IN CITIZEN SCIENCE**
...
- **COULD USE FOR COVARIATE SPATIAL SCALE EFFECTS**
...
### Zurell2016
Zurell, D., Thuiller, W., Pagel, J., Cabral, J. S., Münkemüller, T., Gravel, D., et al. (2016). Benchmarking novel approaches for modelling species range dynamics. Glob. Chang. Biol. 22, 2651–2664. doi:10.1111/gcb.13251.
